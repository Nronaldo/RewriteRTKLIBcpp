...
const short maxout = 3;
const short minlock = 5;
const short minfix = 5;
...
const double prn[6] = { 1E-4,1E-3,1E-4,0.1,0.01,0.0 };//prnbias,prniono,prntrop,prnaccelh,prnaccelv,prnpos
...
const double opteratio[3] = { 100.0,300.0,100.0 };
const double optthresar[8] = { 3.0,0.1,0.25,0.1,0.05,0.0,0.0,0.0 };
const int optminfixsats = 2;
